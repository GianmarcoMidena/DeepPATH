...
def inception_v3(inputs,
  ...
  end_points = {}
  sel_end_points = {}
  with tf.compat.v1.name_scope(scope, 'inception_v3', [inputs]):
    with scopes.arg_scope([ops.conv2d, ops.fc, ops.batch_norm, ops.dropout],
      ...
      with scopes.arg_scope([ops.conv2d, ops.max_pool, ops.avg_pool],
        ...
        with tf.compat.v1.variable_scope('mixed_35x35x256a'):
          ...
          sel_end_points['mixed_35x35x256a'] = net
        ...
        with tf.compat.v1.variable_scope('mixed_17x17x768b'):
          with tf.compat.v1.variable_scope('branch1x1'):
            branch1x1 = ops.conv2d(net, 192, [1, 1])
          with tf.compat.v1.variable_scope('branch7x7'):
            branch7x7 = ops.conv2d(net, 128, [1, 1])
            branch7x7 = ops.conv2d(branch7x7, 128, [1, 7])
            branch7x7 = ops.conv2d(branch7x7, 192, [7, 1])
          with tf.compat.v1.variable_scope('branch7x7dbl'):
        ...
        with tf.compat.v1.variable_scope('mixed_17x17x768c'):
          with tf.compat.v1.variable_scope('branch1x1'):
            branch1x1 = ops.conv2d(net, 192, [1, 1])
          with tf.compat.v1.variable_scope('branch7x7'):
        ...
        with tf.compat.v1.variable_scope('mixed_17x17x768d'):
          with tf.compat.v1.variable_scope('branch1x1'):
            branch1x1 = ops.conv2d(net, 192, [1, 1])
          with tf.compat.v1.variable_scope('branch7x7'):
            branch7x7 = ops.conv2d(net, 160, [1, 1])
        ...
        with tf.compat.v1.variable_scope('mixed_17x17x768e'):
          with tf.compat.v1.variable_scope('branch1x1'):
            branch1x1 = ops.conv2d(net, 192, [1, 1])
          with tf.compat.v1.variable_scope('branch7x7'):
          ...
          sel_end_points['mixed_17x17x768e'] = net
        ...
        with tf.compat.v1.variable_scope('mixed_17x17x1280a'):
          with tf.compat.v1.variable_scope('branch3x3'):
            branch3x3 = ops.conv2d(net, 192, [1, 1])
            branch3x3 = ops.conv2d(branch3x3, 320, [3, 3], stride=2,
                                   padding='VALID')
          with tf.compat.v1.variable_scope('branch7x7x3'):
        ...
        with tf.compat.v1.variable_scope('mixed_8x8x2048a'):
          with tf.compat.v1.variable_scope('branch1x1'):
        ...
        with tf.compat.v1.variable_scope('mixed_8x8x2048b'):
          with tf.compat.v1.variable_scope('branch1x1'):
            branch1x1 = ops.conv2d(net, 320, [1, 1])
          with tf.compat.v1.variable_scope('branch3x3'):
            branch3x3 = ops.conv2d(net, 384, [1, 1])
